      ...
      <Link
        className={
          isLight
            ...
            : "bg-white flex flex-row items-center justify-center gap-2 rounded-md border-1 px-4 py-2 font-medium text-primary"
        }
        href={href}
      >
        <span>{cta}</span>
          ...
          <span className="relative flex h-[13px] w-[13px] overflow-hidden">
            {[
              ...
              <motion.svg
                ...
                fill="none"
              >
                <path d={ARROW_PATH} fill={isLight ? "white" : "#3A27B5"} />
              </motion.svg>
            ))}
          </span>
        </div>
