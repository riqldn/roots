      ...
      <section className="min-h-max w-full overflow-x-hidden border-y-1 border-white/10 py-16">
        <div className="mx-auto min-h-max w-9/10">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
            {reports.slice().reverse().map((report: any, i) => {
              ...
              return (
                <Link key={i * 100} href={`insights/${report.fields.slug}`}>
                  <div key={i}>
                    ...
                    <div key={report.sys.id * 5} className="relative py-4">
                     

                      {/* Title */}
                      <h3 className="text-[16px] leading-snug font-semibold text-white mb-2">
                        {report.fields.title}
                      </h3>
                      <h4 className="text-[12px] leading-snug font-semibold text-white/50">{report.fields.date}</h4>
                    </div>
                  </div>
                </Link>
              );
